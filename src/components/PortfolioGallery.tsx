        ...
        {filtered.map((session) => (
          ...
          >
            ...
            <div className="relative aspect-16/10 overflow-hidden bg-slate-900">
              ...
              <div className="absolute bottom-2 right-2 px-2 py-0.5 rounded-md bg-black/60 text-white text-[10px] font-medium flex items-center gap-1">
            ...
            <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-100 text-[11px] text-slate-600 space-y-1 mt-2">
                  <div className="flex items-center gap-1 text-[#25324B] font-bold">
                    <Brain className="w-3.5 h-3.5 text-[#7C5CFC]" />
                    <span>Penalaran Murid:</span>
                  </div>
                  <p className="line-clamp-2 italic">“{session.answers.reason}”</p>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-slate-100 flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-2 px-3 rounded-xl bg-gradient-to-r from-[#4F8EF7] to-[#7C5CFC] hover:shadow-sm text-white text-xs font-bold flex items-center justify-center gap-1.5 transition-all"
                >
